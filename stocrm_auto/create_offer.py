...
login_form = driver.find_element(By.CSS_SELECTOR, "[type = Text]").send_keys("pavel_d@demo.ru")
password_form = driver.find_element(By.CSS_SELECTOR, "[type = Password]").send_keys("CLGmL6ZN!")
